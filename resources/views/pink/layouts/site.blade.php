                ...
                <div class="sidebar group">
                    ...
                    <div class="widget-first widget recent-posts">
                        ...
                        <div class="recent-post group">
                            <div class="hentry-post group">
                                <div class="thumb-img"><img src="{{asset(env('THEME')) }}/images/articles/001-55x55.png"
                            ...
                            <div class="hentry-post group">
                                <div class="thumb-img"><img src="{{asset(env('THEME')) }}/images/articles/003-55x55.jpg"
                            ...
                            <div class="hentry-post group">
                                <div class="thumb-img"><img
                                            src="{{asset(env('THEME')) }}/images/articles/0037-55x55.jpg" alt="0037"
                                            title="0037"/></div>
                                <div class="text">
                    ...
                    <div class="widget-last widget text-image">
                        ...
                        <div class="text-image" style="text-align:left"><img
                                    src="{{asset(env('THEME')) }}/images/callus.gif" alt="Customer support"/></div>
